...
n = [l.estimator.feature_importances_.shape[0]
     for l in ensemble.layer_2.learners[0].learner_][0]
...
params = {'svc': {'C': uniform(0, 10)},
          'class__rf': {'max_depth': randint(2, 10)},
          'proba__rf': {'max_depth': randint(2, 10),
