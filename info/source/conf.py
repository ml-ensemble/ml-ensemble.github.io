...
# -*- coding: utf-8 -*-
#
# mlens documentation build configuration file, created by
# sphinx-quickstart on Wed Mar  8 15:27:54 2017.
#
...
latex_documents = [
    (master_doc, 'mlens.tex', 'mlens Documentation',
     'Sebastian Flennerhag', 'manual'),
]
...
def setup(app):
    # Custom CSS
    app.add_stylesheet('css/mlens_theme.css')
